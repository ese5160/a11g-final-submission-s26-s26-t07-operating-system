...
| ID     | Description                                                                                                                                                                                                                                                                                                            |
| ------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| HRS-01 | A force sensing resistor shall be used for detecting when the goggles are worn. The force sensing resistor shall detect forces in the range from 0N to 5N with a resolution of ±0.5N to determine the state of the goggles, and it will detect the goggles being worn when the force sensor detects a force of >= 2N. |
| HRS-02 | A gas sensor sensor shall detect when VOCs are present in front of the goggles. The IAQ should have an output between 0 to 500 with a resolution of 1 to indicate air quality.                                                                                                                                         |
| HRS-03 | A temperature sensor should monitor the ambient temperature between 40°C to 85°C with an accuracy of ±1.0°C.                                                                                                                                                                                                       |
| HRS-04 | A buzzer shall be used to indicate unsafe environmental conditions. The buzzer shall sound at a minimum of 50 dB when it is actuated.                                                                                                                                                                                  |
| HRS-05 | An LED shall display red, yellow, or green colors to indicate the safety conditions of the environment.                                                                                                                                                                                                                |
| HRS-06 | An LCD screen should constantly be displaying live environmental conditions, including the temperature and air quality. The latency between measurement to display should be less than 100 milliseconds.                                                                                                               |

| ID     | Description                                                                                                                                                              |
| ------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| SRS-01 | The information from the gas and temperature sensors in the BME688 shall be sampled at a rate of 100 Hz.                                                                |
| SRS-02 | The force sensor shall be sampled at a rate of 10 Hz.                                                                                                                    |
| SRS-03 | When the index air quality crosses a set threshold for unhealthy air, a flag shall be raised which triggers the buzzer and turns the LED red within 1 second.            |
| SRS-04 | The LED should provide constant feedback on air quality: green for good/healthy, yellow for medium, and red for unhealthy. This should be updated every 10 milliseconds. |
...
| SRS-06 | The MCU should provide feedback via an app or webpage about the environmental conditions, notifying the user within 1 second if a dangerous condition is present.        |
